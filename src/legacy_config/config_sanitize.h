...
// Frozen with the reader beside it (see legacy_config.h): the value guards
// v0.1.0 applied to HeadTracking.ini, moved from src/config_sanitize.h into
// namespace wf_ht::legacy and otherwise unchanged.
